...
def main():
    ...
    parser.add_argument(
        "--split_traj_path",
        default='/root/NavDataGeneration/data/traj_datasets/objectnav/cloudrobo_v1_l3mvn_all/train/content',
        help="Path to the directory containing split trajectory files.",
    )
    parser.add_argument(
        "--merged_traj_path",
        default='/root/NavDataGeneration/data/traj_datasets/objectnav/cloudrobo_v1_l3mvn_all/train/content_merge',

...
def precheck_args(args):
    ...
    if args.dataset_type == "traj_datasets":
        ...
        if args.gen_traj_method not in args.input_path:
            print(f"❌ 参数 input_path {args.input_path} 路径中必须包含 gen_traj_method: {args.gen_traj_method}")
            invalid_args.append("input_path")
...
if __name__ == "__main__":
    ...
    parser.add_argument("--input_path", default="data/traj_datasets/objectnav/cloudrobo_v1_l3mvn_all/train/content_metrics", help="数据集路径")
    ...
    # 数据配方tag
    parser.add_argument("--recipe_tag", default='cloudrobo_v1_l3mvn_all', help="数据配方标签")
